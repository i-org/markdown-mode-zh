...
**废弃：由于自己设计了il，效果满意，此放弃维护**

欢迎使用 [IL](https://gitlab.com/jobinson99/il)
...
必需设置 markdown-command，否则将导致找不到渲染引擎。
...
<a href="https://leanpub.com/markdown-mode"># Emacs Markdown Mode [![MELPA badge][melpa-badge]][melpa-link] [![MELPA stable badge][melpa-stable-badge]][melpa-stable-link] [![Travis CI Build Status][travis-badge]][travis-link] [![Guide to Markdown Mode for Emacs][leanpub-badge]][leanpub-link]
