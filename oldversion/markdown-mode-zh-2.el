;;; markdown-mode-zh.el --- Emacs Major mode for Markdown-formatted text files

;; fork from http://jblevins.org/projects/markdown-mode/
...
(defvar markdown-mode-map
  (let ((map (make-keymap)))
    ...
    (define-key map (kbd "M-l") 'markdown-insert-list-item)
    ;; Movement
